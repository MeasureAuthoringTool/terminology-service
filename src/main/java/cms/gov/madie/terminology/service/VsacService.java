...
public class VsacService {
   ...
   * @return List of CqlCodes with their validation results
   * If an associated CodeSystem is not available for a code, then this method will skip validating that code,
   * an error will be displayed to user by cql-elm-translator
   */
